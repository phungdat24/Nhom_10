        ...
        try {
            switch (msg.getType()) {
                ...
                case "GET_MY_ACUTIONS":
                    ...
                    try{
                        List<com.nhomX.example.model.MyAuctionDTO> myAuctionList = auctionRepository;
                ...
                case "REGISTER":
                    ...
                    com.nhomX.example.service.EmailService emailService = new
                            com.nhomX.service.emailService.sendOtp(email, tempOtpCode);
