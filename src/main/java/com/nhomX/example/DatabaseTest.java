                ...
                try (Connection conn = DatabaseConnection.getInstance().getConnection();
                        ...
                        String insertImages =
                                        "INSERT INTO item_images (id, image_path, item_id) VALUES "
                                                        ...
                                                        + "('IMG001_1', 'item1.png', 'ITM001'), "
                                                        + "('IMG001_2', 'laptop_2.png', 'ITM001'), "
                                                        + "('IMG001_3', 'laptop_3.png', 'ITM001'), "
                                                        + "('IMG001_4', 'laptop_4.png', 'ITM001'), "
                                                        + "('IMG001_5', 'laptop_5.png', 'ITM001'), "
                                                        + "('IMG002_1', 'item2.png', 'ITM002'), "
                                                        + "('IMG002_2', 'rolex_2.png', 'ITM002'), "
                                                        + "('IMG002_3', 'rolex_3.png', 'ITM002'), "
                                                        + "('IMG002_4', 'rolex_4.png', 'ITM002'), "
                                                        + "('IMG002_5', 'rolex_5.png', 'ITM002'), "
                        ...
                        String insertAuctions =
                                        "INSERT INTO auctions (id, starting_price, highest_bid, start_time, end_time, status, item_id) VALUES "
                                                        + "('AUC001', 15000, 15000, '2026-05-10 08:00:00', '2026-05-18 15:10:00', 'OPEN', 'ITM001'), "
                                                        + "('AUC002', 80000, 80000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM002'), "
                                                        + "('AUC003', 25000, 25000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM003'), "
                                                        + "('AUC004', 30000, 30000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM004'), "
                                                        + "('AUC005', 12000, 12000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM005'), "
                                                        + "('AUC006', 80000, 80000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM006'), "
                                                        + "('AUC007', 50000, 50000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM007'), "
                                                        + "('AUC008', 35000, 35000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM008'), "
                                                        + "('AUC009', 45000, 45000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'PENDING', 'ITM009'), "
                                                        + "('AUC010', 60000, 60000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'PENDING', 'ITM010'), "
                                                        + "('AUC011', 28000, 28000, '2026-05-23 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM011'), "
                                                        + "('AUC012', 14000, 14000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM012'), "
                                                        + "('AUC013', 85000, 85000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM013'), "
                                                        + "('AUC014', 50000, 50000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM014'), "
                                                        + "('AUC015', 30000, 30000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM015'), "
                                                        + "('AUC016', 12000, 12000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM016'), "
                                                        + "('AUC017', 22000, 22000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM017'), "
                                                        + "('AUC018', 75000, 75000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM018'), "
                                                        + "('AUC019', 20000, 20000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM019'), "
                                                        + "('AUC020', 15000, 15000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM020'), "
                                                        + "('AUC021', 90000, 90000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM021'), "
                                                        + "('AUC022', 18000, 18000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM022'), "
                                                        + "('AUC023', 11000, 11000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM023'), "
                                                        + "('AUC024', 45000, 45000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM024'), "
                                                        + "('AUC025', 95000, 95000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM025'), "
                                                        + "('AUC026', 65000, 65000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM026'), "
                                                        + "('AUC027', 18000, 18000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM027'), "
                                                        + "('AUC028', 32000, 32000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM028'), "
                                                        + "('AUC029', 55000, 55000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM029'), "
                                                        + "('AUC030', 89000, 89000, '2026-05-10 08:00:00', '2027-12-31 23:59:00', 'OPEN', 'ITM030')";
                        stmt.executeUpdate(insertAuctions);

                        logger.info("--------------------------------------------------");
                        logger.info("✅ THÀNH CÔNG: Đã nạp dữ liệu mẫu 30 sản phẩm vào cấu trúc mới!");
                        logger.info("   - Đã xóa sạch dữ liệu cũ.");
                        logger.info("   - Đã tạo 2 người dùng mẫu.");
                        logger.info("   - Đã tạo 30 sản phẩm.");
                        logger.info("   - Đã tách 30 ảnh vào bảng item_images.");
                        logger.info("   - Đã đưa 30 sản phẩm lên sàn đấu giá (auctions).");
                        logger.info("--------------------------------------------------");

                } catch (Exception e) {
                        logger.error("❌ Lỗi khi nạp dữ liệu test", e);
                }
        }
}
