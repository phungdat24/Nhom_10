...
public class DatabaseTest {
        public static void main(String[] args) {
                try (Connection conn = DatabaseConnection.getInstance().getConnection();
                        ...
                        String insertUsers = "INSERT INTO users (id, username, password, fullname, balance, role) VALUES "
                                        + "('U001', '25021715@vnu.vn','" + pass
                                        + "'  , 'Nguyen Van Ban', 5000000000000000, 'USER'), "
                                        + "('U002', 'phung@gmail.com', '" + pass
                                        + "', 'Tran Thi Mua', 500000000, 'USER'),"
                                        + "('U003', '123@gmail.com', '" + pass + "', 'FuckYou', 500000000, 'USER'),"
                                        + "('A001', 'admin@gmail.com', '" + pass + "', 'Admin Tester', 0, 'ADMIN')";
                        stmt.executeUpdate(insertUsers);

                        // --- ITEMS (30 món hoành tráng) ---
                        String insertItems = "INSERT INTO items (id, title, description, category, seller_id) VALUES "
