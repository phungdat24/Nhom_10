...
/**
 * SessionManager — Singleton Lưu thông tin User đang đăng nhập, dùng chung toàn bộ ứng dụng. Không
 * phân biệt role: một User vừa có thể đấu giá, vừa có thể bán hàng.
 */
