...
public class DatabaseConnection {
  ...
  public static synchronized void resetForTests() {
    ...
    instance = null;
    logger.info("Đã reset Database Connection instance");
  }
  ...
  private void createTables() {
    ...
    try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
      ...
      String createAuctionsTable = "CREATE TABLE IF NOT EXISTS auctions (" + "id TEXT PRIMARY KEY, "
          ...
          + "winner_id TEXT, " + "approved_by TEXT, "
          + "FOREIGN KEY(item_id) REFERENCES items(id), "
      ...
      String createAutoBidsTable = "CREATE TABLE IF NOT EXISTS auto_bids ("
          + "id TEXT PRIMARY KEY, " + "max_price INTEGER, " + "step_price INTEGER, "
          + "is_active INTEGER DEFAULT 1, " + "created_at TEXT, " + "user_id TEXT, "
      ...
      logger.info("Khởi tạo cấu trúc Database mới thành công");
    } catch (SQLException e) {
      logger.error("Lỗi khi tạo bảng", e);
    }
  }
}
